...
<dependency>
    ...
    <version>R5-B308</version>  <!-- This version is automatically updated -->
</dependency>
```
...
dependencies {
    implementation 'org.bsdevelopment.simplepets:api:R5-B308' // This version is automatically updated
}
```
