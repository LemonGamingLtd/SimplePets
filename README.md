...
<dependency>
    ...
    <version>R5-B300</version>  <!-- This version is automatically updated -->
</dependency>
```
...
dependencies {
    implementation 'org.bsdevelopment.simplepets:api:R5-B300' // This version is automatically updated
}
```
