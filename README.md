...
<dependency>
    ...
    <version>R5-B306</version>  <!-- This version is automatically updated -->
</dependency>
```
...
dependencies {
    implementation 'org.bsdevelopment.simplepets:api:R5-B306' // This version is automatically updated
}
```
