...
public interface ISpawnUtil {
     ...
     */
    BiOptional<IEntityPet, String> spawnEntityPet(PetType type, PetUser user, CompoundData compound);
     ...
     * @param location - Location to spawn the pet at
     */
    BiOptional<IEntityPet, String> spawnEntityPet(PetType type, PetUser user, CompoundData compound, Location location);
