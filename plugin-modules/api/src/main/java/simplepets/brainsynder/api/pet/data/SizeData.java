...
public class SizeData extends PetData<ISizable> {
    public SizeData() {
        addDefaultItem("1", ItemBuilder.playerSkull("http://textures.minecraft.net/texture/ca516fbae16058f251aef9a68d3078549f48f6d5b683f19cf5a1745217d72cc")
            .withName("&#c8c8c8{name}: &#e1eb5b1"));
        addDefaultItem("2", ItemBuilder.playerSkull("http://textures.minecraft.net/texture/4698add39cf9e4ea92d42fadefdec3be8a7dafa11fb359de752e9f54aecedc9a")
            .withName("&#c8c8c8{name}: &#e1eb5b2"));
        addDefaultItem("3", ItemBuilder.playerSkull("http://textures.minecraft.net/texture/fd9e4cd5e1b9f3c8d6ca5a1bf45d86edd1d51e535dbf855fe9d2f5d4cffcd2")
            .withName("&#c8c8c8{name}: &#e1eb5b3"));
        addDefaultItem("4", ItemBuilder.playerSkull("http://textures.minecraft.net/texture/f2a3d53898141c58d5acbcfc87469a87d48c5c1fc82fb4e72f7015a3648058")
    ...
    public Optional<ItemBuilder> getItem(ISizable entity) {
        ...
        if (!optional.isPresent()) {
            if (!getSizes(entity).contains(entity.getSize()))
                ...
                return Optional.of(ItemBuilder.playerSkull("http://textures.minecraft.net/texture/bc8ea1f51f253ff5142ca11ae45193a4ad8c3ab5e9c6eec8ba7a4fcb7bac40")
