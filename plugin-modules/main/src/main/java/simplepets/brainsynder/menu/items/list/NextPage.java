...
public class NextPage extends Item {
    ...
    public ItemBuilder getDefaultItem() {
        return ItemBuilder.playerSkull("http://textures.minecraft.net/texture/956a3618459e43b287b22b7e235ec699594546c6fcd6dc84bfca4cf30ab9311")
    ...
    public void onClick(PetUser owner, CustomInventory inventory, IEntityPet pet) {
        if (inventory instanceof SelectionMenu menu) {
