        ...
        if (args[0].equalsIgnoreCase("pets")) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    sender.sendMessage(PetCore.getInstance().getMessageFile().getTranslation(MessageOption.PET_FILES_REGEN));
                }
        ...
        if (args[0].equalsIgnoreCase("inventories")) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    sender.sendMessage(PetCore.getInstance().getMessageFile().getTranslation(MessageOption.INV_FILES_REGEN));
                }
            }.runTaskLater(getPlugin(), 2);
            return;
        }
        ...
        if (args[0].equalsIgnoreCase("items")) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    sender.sendMessage(PetCore.getInstance().getMessageFile().getTranslation(MessageOption.ITEM_FILES_REGEN));
                }
            }.runTaskLater(getPlugin(), 2);
            return;
        }
        ...
        if (args[0].equalsIgnoreCase("particles")) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    sender.sendMessage(PetCore.getInstance().getMessageFile().getTranslation(MessageOption.PARTICLE_FILES_REGEN));
                }
            }.runTaskLater(getPlugin(), 2);
            return;
        }
        ...
        if (args[0].equalsIgnoreCase("type")) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    sender.sendMessage(PetCore.getInstance().getMessageFile().getTranslation(MessageOption.PET_TYPE_FILE_REGEN).replace("{type}", type.getName()));
                }
